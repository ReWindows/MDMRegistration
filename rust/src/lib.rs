//! Windissect-generated Rust FFI bindings for MDMRegistration.DLL. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "A4C9B5EB38F04314CA3BDD15D28D6147";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2558804662;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 20] = [77, 68, 77, 82, 101, 103, 105, 115, 116, 114, 97, 116, 105, 111, 110, 46, 68, 76, 76, 0];
        ...
        if live_timestamp != 2558804662 { return 0; }
